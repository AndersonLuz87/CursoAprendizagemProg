...
let vendasemgorjeta = 0

for (let containdividual of receita) {

vendasemgorjeta = vendasemgorjeta + containdividual['valor']

}
console.log("O valor total de vendas sem gorjeta é R$",vendasemgorjeta)

//Problema 2: Qual o valor total de vendas incluindo a gorjeta?

let valorContaTotal = 0
let faturamentoTotal = 0

for (let containdividual of receita) {

    valorContaTotal = containdividual['valor'] + containdividual['gorjeta']
    faturamentoTotal = faturamentoTotal + valorContaTotal
}

console.log("O valor total de vendas incluindo a gorjeta é de R$",faturamentoTotal)

//Problema 3: Quantas vendas foram abaixo de 50 reais?

let contadorDeVendasBaixas = 0
let valorContaMesa = 0

for ( let containdividual of receita) {
    
    valorContaMesa = containdividual ['valor'] + containdividual ['gorjeta']
    if (valorContaMesa < 50) {
        contadorDeVendasBaixas ++
    }       
 
}

console.log("Foram feitas",contadorDeVendasBaixas,"vendas abaixo de 50 reais") 